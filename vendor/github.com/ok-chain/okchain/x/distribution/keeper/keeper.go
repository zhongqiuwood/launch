...
type Keeper struct {
	...
	kValidatorsSnapShot sdk.StoreKey
	kDelegationSnapshot sdk.StoreKey
...
// create a new keeper
func NewKeeper(cdc *codec.Codec, key, kValSnap, kDelSnap sdk.StoreKey, paramSpace params.Subspace, ck types.BankKeeper,
	sk types.StakingKeeper, fck types.FeeCollectionKeeper, codespace sdk.CodespaceType) Keeper {
	keeper := Keeper{
		storeKey:            key,
		kValidatorsSnapShot: kValSnap,
		kDelegationSnapshot: kDelSnap,
		cdc:                 cdc,
