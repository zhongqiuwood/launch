...
func DefaultParams() Params {
	return Params{
		NewOrder:           sdk.NewDecWithPrec(0, 0),
		Cancel:             sdk.NewDecWithPrec(1, 2),
		CancelNative:       sdk.NewDecWithPrec(2, 2),
		Expire:             sdk.NewDecWithPrec(1, 2),
		ExpireNative:       sdk.NewDecWithPrec(2, 2),
		TradeFeeRate:       sdk.NewDecWithPrec(1, 3),
		TradeFeeRateNative: sdk.NewDecWithPrec(4, 4),
	}
}
