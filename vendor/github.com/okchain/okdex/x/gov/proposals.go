...
func (tp DexListProposal) GetTotalDeposit() sdk.Coins              { return tp.TotalDeposit }
func (tp *DexListProposal) SetTotalDeposit(totalDeposit sdk.Coins) { tp.TotalDeposit = totalDeposit }
