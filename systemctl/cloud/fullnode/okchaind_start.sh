...
. /tmp/okchain/launch/systemctl/cloud/fullnode/okchaind.profile
...
. /tmp/okchain/launch/systemctl/cloud/fullnode/seednode.profile
...
${OKCHAIN_DAEMON} start --home ${HOME_DAEMON} \
    ...
    --log_level *:info \
    --p2p.laddr tcp://${LOCAL_IP}:26656  2>&1 >> /tmp/okchain/okchaind.log